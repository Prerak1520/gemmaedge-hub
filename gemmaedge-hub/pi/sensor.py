...
def load_skill() -> str:
    ...
    return "You are a helpful vision assistant running on a Raspberry Pi."
...
def run() -> None:
    log.info("GemmaEdge Pi sensor starting — model=%s", LOCAL_MODEL)
